...
${OBJECTDIR}/UseThePriorityQueue.o: UseThePriorityQueue.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/UseThePriorityQueue.o UseThePriorityQueue.c

${OBJECTDIR}/ThePriorityQueue.o: ThePriorityQueue.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ThePriorityQueue.o ThePriorityQueue.c
